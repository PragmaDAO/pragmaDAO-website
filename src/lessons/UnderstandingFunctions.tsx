...
const UnderstandingFunctions: React.FC<{
  ...
  const handleMarkComplete = async () => {
    ...
    try {
      ...
      const response = await fetch(`${backendUrl}/api/progress`, {
        ...
        body: JSON.stringify({ lessonId: "understanding-functions", completed: true }),
      });
  ...
  const handleGoToPreviousLesson = () => {
    const currentLessonIndex = lessons.findIndex(lesson => lesson.id === "understanding-functions");
